...
import 'package:marketify/pages/address/widgets/search_location_dialogue_page.dart';
...
class _PickAddressMapState extends State<PickAddressMap> {
  ...
  void initState() {
    ...
    if (Get.find<LocationController>().addressList.isEmpty) {
      _initialPosition = LatLng(-8.620932815641462, 115.16657399823436);
