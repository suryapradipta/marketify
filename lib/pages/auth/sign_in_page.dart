      ...
      if (phone.isEmpty) {
        final phoneEmptyBar = SnackBar(
          ...
          content: AwesomeSnackbarContent(
            title: 'Phone!',
            message:
                'Phone number field cannot be left empty. Please enter your phone number.',
        ...
        final passwordEmptyBar = SnackBar(
          ...
          content: AwesomeSnackbarContent(
            title: 'Password!',
            message:
                'Password field cannot be left empty. Please enter your password.',
            contentType: ContentType.warning,
          ),
        );
        ...
        final passwordLengthBar = SnackBar(
          elevation: 0,
          behavior: SnackBarBehavior.floating,
          backgroundColor: Colors.transparent,
          content: AwesomeSnackbarContent(
        ...
        ScaffoldMessenger.of(context)
          ..hideCurrentSnackBar()
          ..showSnackBar(passwordLengthBar);
      } else {
