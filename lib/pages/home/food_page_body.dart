...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  @override
  void initState() { // to know the current page value
    super.initState();
      ...
      children: [
        ...
        GetBuilder<RecommendedProductController>(builder: (recommendedProduct) {
          return recommendedProduct.isLoaded?ListView.builder(
              physics: NeverScrollableScrollPhysics(), // scrollable all body page
              shrinkWrap: true,
              ...
              itemBuilder: (context, index){
                return GestureDetector(
                  ...
                  child: Container(
                    margin: EdgeInsets.only(left: Dimensions.width20, right: Dimensions.width20, bottom: Dimensions.height10), // margin untuk kiri gambar dan kanan text container
                    child: Row(
                      children: [
                        // IMAGE SECTION CONTAINER
                        Container( // show the image
                        ...
                        Expanded(
                          child: Container( // container di dalam expanded akan mengambil semua available space
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      IconAndTextWidget(icon: Icons.price_check,
                                          text: recommendedProduct.recommendedProductList[index].price!.toString(),
  ...
  Widget _buildPageItem(int index, ProductModel popularProduct) {
    ...
    Matrix4 matrix = new Matrix4.identity(); //\\ dynamic scale the hero section when slider
    if(index == _currPageValue.floor()) { //\\  current page scale
      var currScale = 1-(_currPageValue-index)*(1-_scaleFactor);
      var currTrans = _height*(1-currScale)/2; //\\ to create transform scale while slider //\\ mengecil ketika slider
      matrix = Matrix4.diagonal3Values(1, currScale, 1)..setTranslationRaw(0, currTrans, 0);
    } else if(index == _currPageValue.floor()+1) { //\\ next page scale
      var currScale = _scaleFactor+(_currPageValue-index+1)*(1-_scaleFactor);
      var currTrans = _height*(1-currScale)/2;
      matrix = Matrix4.diagonal3Values(1, currScale, 1);
      matrix = Matrix4.diagonal3Values(1, currScale, 1)..setTranslationRaw(0, currTrans, 0);
    } else if(index == _currPageValue.floor()-1) { //\\ before page scale
      var currScale = 1-(_currPageValue-index)*(1-_scaleFactor);
      var currTrans = _height*(1-currScale)/2;
      matrix = Matrix4.diagonal3Values(1, currScale, 1);
      matrix = Matrix4.diagonal3Values(1, currScale, 1)..setTranslationRaw(0, currTrans, 0);
    } else { //\\smooth the slider
      var currScale = 0.8;
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(left: Dimensions.width10, right: Dimensions.width10), //\\ give empty space between page menu in hero section
              decoration: BoxDecoration(
          ...
          Align(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(left: Dimensions.width30, right: Dimensions.width30, bottom: Dimensions.height30), // size margin of description box on hero section // position of description box
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radius20),
                  color: Colors.white,
